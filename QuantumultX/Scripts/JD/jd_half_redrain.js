...
async function retryCdn(code, url) {
    if (code === 'error') {
        ...
        let cndUrl = `https://github.com/yogayyy/Scripts/master/QuantumultX/Scripts/JD/jd-half-rain.json`
...
function rraUrl() {
    let url = 'https://github.com/yogayyy/Scripts/master/QuantumultX/Scripts/JD/jd-half-rain.json'
